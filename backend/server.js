...
const dbUrl = `mongodb+srv://admin:lDwDH1ijgV95YOd8@cluster0.hylimuo.mongodb.net/?retryWrites=true&w=majority`;
...
let PostModel = mongoose.model("SimplePost", PostSchema);
...
app.post('/addpost', async (req, res) => {
    ...
    let post = new PostModel(inputBook);
    try {
